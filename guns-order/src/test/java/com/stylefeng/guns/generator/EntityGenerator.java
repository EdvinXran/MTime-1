...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("E:\\MTime\\guns-order\\src\\main\\java");//这里写你自己的java目录
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/mtime?characterEncoding=utf8&serverTimezone=GMT");
        ...
        strategy.setInclude(new String[]{"mtime_order_t"});
